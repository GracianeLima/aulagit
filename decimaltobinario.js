...
function teste_decimal_octal(){
    ...
    if(resultado=="100"){
        ...
        console.log("Falhou no teste no decimal 64 e binario 100")
    }
    resultado=decimal_octal(0);
    if(resultado=="0"){
        console.log("Passou o teste no decimal 0 e binario 0");
    }
    else{
        console.log("Falhou no teste no decimal 0 e binario 0")
    }
}
teste_decimal_octal();